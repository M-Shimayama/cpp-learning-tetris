...
LRESULT CALLBACK WndProc(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    switch(msg) {
        case WM_CREATE: {
            ...
            static LPCTSTR bitmapName = LPCTSTR("BLOCKS");
...
int WinMain(HINSTANCE hInst, HINSTANCE hPrevInst, LPSTR cmdLine, int cmdShow) {
    hInstance = hInst;
    WNDCLASSEX wc;
    static LPCTSTR pClassName = LPCTSTR("NicoNicoProgramming2");  // クラス名
    ...
    hMainWindow = CreateWindow(pClassName, pClassName, WS_OVERLAPPED | WS_MINIMIZEBOX | WS_SYSMENU | WS_CAPTION,
